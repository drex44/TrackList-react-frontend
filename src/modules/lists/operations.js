...
const getAllLists = () => {
  return function(dispatch) {
    API.post(Services.getAllLists).then(res => {
...
const getListById = id => {
  return function(dispatch) {
    API.post(Services.getListById, { id: id }).then(res => {
...
const createList = list => {
  ...
  return function(dispatch) {
    API.post(Services.createNewList, list).then(res => {
      list = res.data;
...
const deleteList = id => {
  return function(dispatch) {
    API.post(Services.deleteList, { id: id }).then(res => {
...
const editList = list => {
  return function(dispatch) {
    ...
    API.post(Services.editList, list).then(res => {
