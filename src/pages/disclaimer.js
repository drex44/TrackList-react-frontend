...
export function DisclaimerPolicy(props) {
  return (
    <Container>
      ...
      <p>
        All the information on this website - www.tracklist.com - is published
        in good faith and for general information purpose only. TrackList does
        ...
        on this website (TrackList), is strictly at your own risk. TrackList
