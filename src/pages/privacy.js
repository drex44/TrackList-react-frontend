...
export function PrivacyPolicy(props) {
  return (
    <Container>
      <h2>Who we are</h2>
      Our website address is: https://www.tracklist.com. we have various posts
      on technical and financial guides.
      ...
      comment, your profile picture is visible to the public in the context of
      your comment.
      <h3>Media</h3>
      ...
      <h3>Contact forms</h3>
      we save all the details you insert in all the form on our website. we
      don't have any control or liability if you go to any external page from
      our website and insert data in any form.
      <h3>Cookies</h3>
      ...
      comment. These cookies will last for one year. If you have an account and
      you log in to this site, we will set a temporary cookie to determine if
      your browser accepts cookies. This cookie contains no personal data and is
      discarded when you close your browser. When you log in, we will also set
      up several cookies to save your login information and your screen display
      choices. Login cookies last for two days, and screen options cookies last
      for a year. If you select "Remember Me", your login will persist for two
      ...
      including tracing your interaction with the embedded content if you have
