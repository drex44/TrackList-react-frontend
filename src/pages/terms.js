  ...
  return (
    <Container>
      ...
      <p>
        ...
        carefully before using the htttps://www.tracklist.com website (the
        "Service") operated by TrackList ("us", "we", or "our").
      </p>
      <p>
      ...
      <p>
        ...
        Service. This Terms and Conditions agreement for TrackList is powered by{" "}
      ...
      <p>
        ...
        are not owned or controlled by TrackList.
      </p>
      <p>
        TrackList has no control over, and assumes no responsibility for, the
        content, privacy policies, or practices of any third party web sites or
        services. You further acknowledge and agree that TrackList shall not be
      ...
      <p>
        ...
        of Gujarat, India, without regard to its conflict of law provisions.
      </p>
      <p>
